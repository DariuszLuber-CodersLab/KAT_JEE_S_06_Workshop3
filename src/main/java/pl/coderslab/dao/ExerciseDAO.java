...
public class ExerciseDAO {
    ...
    private static final String ADD_EXERCISE_QUERY =
    ...
    public void create(Exercise exercise) throws SQLException {
        ...
        try(Connection conn = DbUtil.getConnection()){
            ...
            PreparedStatement statement = conn.prepareStatement(ADD_EXERCISE_QUERY,
            ...
            if(!rs.next()) {
                ...
                throw new SQLException("Exercise primary key was not generated");
    ...
    public Exercise exercise(int exerciseId) {
        try (Connection conn = DbUtil.getConnection()) {
